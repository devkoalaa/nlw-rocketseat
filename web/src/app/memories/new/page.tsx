  ...
  return (
    <div className="flex-1 flex flex-col gap-4">
      ...
      <form className="flex flex-1 flex-col gap-2">
        ...
        name='content' 
        spellCheck={false} 
        className='w-full flex-1 resize-none rounded border-0 bg-transparent p-0 text-lg leading-relaxed text-gray-100 placeholder:text-gray-400 placeholder:pl-1 focus:ring-0'
